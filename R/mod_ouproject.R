...
mod_ouproject_ui <- function(id){
  ...
  tagList(
    bs4Card(status="primary",height = 500,collapsible = FALSE,
      title = "Our Project", width =10,"This project is based on a thesis formulated by Richa Awasthy, the chosen topic of University Industry Collaboration Maturity Model (UICMM) is derived from the document “A Framework for Evaluating and Improving University-Industry Collaboration” published in 2021 by Richa Awasthy.
